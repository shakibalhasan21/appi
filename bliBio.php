		...
		if ($diff > $bl_bio) {
			...
			if ($obj->ServerCopyPin($nid, $user_id)) {
                ...
                try {
                    ...
                    $order_type = "BL BIO";                 // Example order type
                    ...
                    $withdraw = $obj->get_withdraw($user_id, $bl_bio);
                    // Success message
...
<body>
    ...
    <section class="section">
        ...
        <div class="card-body" style="background:lightgrey">
                <h2 class="card-title text-center">বাংলালিংক বায়োমেট্রিক অর্ডার </h2>
                ...
                <div class="form-group text-center">
                    <h5>
                        ...
                        </p></h5><h5>আপনি আপনার বাংলালিংক বায়োমেট্রিক অর্ডার করুন,খুব শিগ্রই ডেলিভারি করা হবে।</h5><h5>
                </h5></div>
                <div align="center" class="form-group">
                <form method="POST" action="" onsubmit="submitForm();">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-6 form-group"><label for="company">বাংলালিংক নাম্বার দিন *</label>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-6 pt-3">
                                <div class="form-group">
                                    <label for="mobile">বাংলালিংক বায়োমেট্রিক সম্পর্কে বিস্তারিত লিখুন।(যদি কিছু বলার থাকে)</label>
                                    <textarea class="form-control" name="note" rows="2"></textarea>
                                </div>
                            </div>
                        </div><!--  row   -->
                        <div style="display: flex;justify-content: center; margin-bottom: 30px; padding-top: 15px;">
                            <span>বাংলালিংক বায়োমেট্রিকর জন্য <?php echo $bl_bio ?> টাকা কাটা হবে।</span><br>
                        </div>
			    ...
			    <?php
                	try {
						...
						if ($user_id == 1) {
							...
							$query = "SELECT * FROM tbl_file_orders WHERE order_type = 'BL BIO' ORDER BY id DESC";
						} else {
							// Get data based on the specific user_id if not 1
							$query = "SELECT * FROM tbl_file_orders WHERE order_type = 'BL BIO' AND user_id = $user_id ORDER BY id DESC";
						}
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
	...
	var b = <?php echo $diff; ?>, c = <?php echo $bl_bio ?>;
    // function submitForm() {
