...
if (!isset($_SESSION['uid'])) {
   ...
   if (isset($_POST['submit'])) {
      ...
      if($obj->is_premium($user_id) != 1){
         if ($diff >= $log_channel) {
            $withdraw = $obj->get_withdraw($user_id, $log_channel);
            $showFrom = false;
         } else {
               ...
               <form action="" method="POST">
                  ...
                  <div class="row">
                     ...
                     <div class="mb-3 myDiv" id="showOne">
                        ...
                        <input type="text" class="form-control" name="father" placeholder="Father's Name (বাংলা)" required>
                     </div>
                     <div class="mb-3 myDiv" id="showOne">
                        <label>Mother's Name (Bangla):</label>
                        <input type="text" class="form-control" name="mother" placeholder="Mother's Name (বাংলা)" required>
                     </div>
                     <div class="mb-3 myDiv" id="showOne">
                     ...
                     <span style="font-size: 12px;padding: 10px;margin: auto;text-align: center; color: red;">
                        <b>Note:</b> আপনার ফাইলের জন্য <?php echo $log_channel ?> টাকা চার্জ কাটা হবে.
                     </span>
                     </div>
                     <br>
