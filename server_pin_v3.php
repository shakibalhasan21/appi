...
if(!isset($_SESSION['uid'])){
	...
	if (isset($_POST['submit'])) {
		...
		if ($diff > $server_pin) {
			$nid = $_POST["nid"];
			$dob = $_POST["dob"];
			$user_id = $_SESSION['uid'] ?? null; // Retrieve user ID from the correct session key
			...
			<div id="inp" class="container">
				...
				<form action="" method="post">
					<div class="row">
						...
						<input type="submit" name="submit" class="btn btn-primary" onclick="submit()" value="Submit To Info Verify" />
