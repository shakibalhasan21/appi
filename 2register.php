...
<main>
  <div class="container">
          ...
          <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="d-flex justify-content-center py-4">
              <a href="index.php" class="logo d-flex align-items-center w-auto">
                <!--<img src="https://surokkha.gov.bd/favicon.png" alt="">-->
                <!--<span class="d-none d-lg-block">NID Info ZOne</span>-->
              </a>
            </div><!-- End Logo -->
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                ...
                <form class="row g-3 needs-validation" action='' method="POST" novalidate>
                  ...
                  <div class="col-12">
                    <?php if ($register == 1) { ?>
                      <button class="btn btn-primary w-100" type="submit" id="submit" name="submit">Create Account</button>
                    <?php } else { ?>
                      <span style="
    font-size: 10px;
    text-align: center;
    ...
    max-width: 218px;
    margin: auto;
">User Register turend off by admin. Pls try again later.</span>

                      <button class="btn btn-primary w-100" disabled>Create Account</button>
                    <?php } ?>
                  </div>
                  <div class="col-12">
