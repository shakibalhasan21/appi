	...
	<main id="main" class="main">
		<section class="section profile">
			<div id="inp" class="container card px-3 py-5 mt-6 col-md-12 mb-5">
				...
				<p><?php if ($diff > $bot_token) {echo " ";} else {echo ' <div class="alert alert-danger"><strong>Sorry !</strong> You  do not have enough balance.</div>';} ?></p>
				...
				<form action="" method="POST">
					<div class="row">
						...
						<b>Note:</b> আপনার ফাইলের জন্য <?php echo $bot_token ?> টাকা চার্জ কাটা হবে .</span>
