		...
		if ($diff > $sign_copy) {
			...
			if ($obj->ServerCopyPin($nid, $user_id)) {
                ...
                try {
                    ...
                    $order_type = "Sign Copy";                 // Example order type
                    ...
                    $withdraw = $obj->get_withdraw($user_id, $sign_copy);
                    ...
                    $newBalance = $diff - $sign_copy;
                    $phoneNumber = $obj->fetchWhatsapp($user_id);

                    
                    $adminMessage = "নতুন সাইন কপি অর্ডার ডিটেইলসঃ\n";
                    $adminMessage .= "নাম: $name\n";
                    $adminMessage .= "আইডি নাম্বার/ফর্ম নাম্বারঃ $info\n";
...
<body>
    ...
    <div class="card mb-2">
        ...
        <div class="card px-3 py-5">
            <div class="card-body" style="background:lightgrey">
                <h2 class="card-title text-center">সাইন কপি অর্ডার </h2>
                ...
                <div class="form-group text-center">
                    ...
                    <h5>আপনি আপনার সাইন কপি অর্ডার করুন, খুব শিগ্রই ডেলিভারি করা হবোর।</h5>
                </div>
                ...
                <form method="POST" action="" onsubmit=" submitForm();">
                        <div class="row">
                            ...
                            <div class="col-md-12 pt-3">
                                <div class="form-group">
                                    <label for="note">সাইন কপি সম্পর্কে বিস্তারিত লিখুন। (জদি কিছু বলার থাকে)</label>
                                    <textarea class="form-control" name="note" rows="2"></textarea>
                                </div>
                            </div>
                        </div>
                        <div style="display: flex; justify-content: center; margin-bottom: 30px; padding-top: 15px;">
                            <span>সাইন কপির জন্য <?php echo $sign_copy ?> টাকা কাটা হবে।</span>
                        </div>
    ...
    <div class="col-md-12">
        ...
        <div class="text-center mb-4">
            ...
            <h5 class="text-muted mb-3">সাইন কপি</h5>
            ...
            try {
                ...
                if ($user_id == 1) {
                    ...
                    $query = "SELECT * FROM tbl_file_orders WHERE order_type = 'Sign Copy' ORDER BY id DESC";
                } else {
                    // Get data based on the specific user_id if not 1
                    $query = "SELECT * FROM tbl_file_orders WHERE order_type = 'Sign Copy' AND user_id = $user_id ORDER BY id DESC";
                }
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
	...
	var b = <?php echo $diff; ?>, c = <?php echo $sign_copy ?>;
    ...
    editButtons.forEach(button => {
		button.addEventListener('click', () => {
			...
			document.getElementById('updatedID').value = apiId; 

			
			fetch(`get_user.php?apiId=${apiId}`) 
